...
- **コンセンサス予報** — JMA MSM / ECMWF IFS / ICON / UKMO / GFS / GEM の6モデルを加重平均し、AMeDAS実測との差で直近12時間を補正。予報と実測の照合ログから、精度の良いモデルの重みを自動で増やし、系統的なズレ (バイアス) も除去する
- **82メンバーアンサンブル** — ECMWF ENS 51 + NOAA GEFS 31。気圧の信頼帯 (P10-P90)・急降下確率・降水確率をメンバー分布から算出
...
- [Open-Meteo](https://open-meteo.com/) — マルチモデル予報 (6モデル) / アンサンブル (ECMWF ENS + GEFS) / 大気質 (CC BY 4.0)
