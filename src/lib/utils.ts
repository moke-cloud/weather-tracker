...
const WMO_WEATHER: Record<number, { icon: string; label: string }> = {
  0: { icon: '\u2600\uFE0F', label: '快晴' },
  1: { icon: '\U0001F324\uFE0F', label: '晴れ' },
  2: { icon: '\u26C5', label: '曇り時々晴れ' },
  3: { icon: '\u2601\uFE0F', label: '曇り' },
  45: { icon: '\U0001F32B\uFE0F', label: '霧' },
  48: { icon: '\U0001F32B\uFE0F', label: '着氷性の霧' },
  51: { icon: '\U0001F326\uFE0F', label: '弱い霧雨' },
  53: { icon: '\U0001F326\uFE0F', label: '霧雨' },
  55: { icon: '\U0001F326\uFE0F', label: '強い霧雨' },
  61: { icon: '\U0001F327\uFE0F', label: '弱い雨' },
  63: { icon: '\U0001F327\uFE0F', label: '雨' },
  65: { icon: '\U0001F327\uFE0F', label: '強い雨' },
  71: { icon: '\u2744\uFE0F', label: '弱い雪' },
  73: { icon: '\u2744\uFE0F', label: '雪' },
  75: { icon: '\u2744\uFE0F', label: '強い雪' },
  80: { icon: '\U0001F326\uFE0F', label: '弱いにわか雨' },
  81: { icon: '\U0001F327\uFE0F', label: 'にわか雨' },
  82: { icon: '\U0001F327\uFE0F', label: '激しいにわか雨' },
  85: { icon: '\U0001F328\uFE0F', label: '弱いにわか雪' },
  86: { icon: '\U0001F328\uFE0F', label: '激しいにわか雪' },
  95: { icon: '\u26C8\uFE0F', label: '雷雨' },
